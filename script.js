class FoodWheel {
    constructor() {
        ...
        this.foodIcons = {
            ...
            'Salad': 'fas fa-leaf',
            'Tacos': 'fas fa-utensils', // Use fork and knife for tacos
            'Hot Dog': 'fas fa-hotdog',
            'Chicken Wings': 'fas fa-drumstick-bite',
            'Fish & Chips': 'fas fa-fish',
            'Sub Sandwich': 'fas fa-sandwich',
            'Ramen': 'fas fa-bowl-food',
            'Pad Thai': 'fas fa-utensils',
            'Curry': 'fas fa-bowl-food',
            'Dumplings': 'fas fa-circle',
            'Teriyaki': 'fas fa-utensils',
            'Lasagna': 'fas fa-layer-group',
            'Risotto': 'fas fa-bowl-food',
            'Calzone': 'fas fa-pizza-slice',
            'Osso Buco': 'fas fa-bone',
            'Grilled Chicken': 'fas fa-drumstick-bite',
            'Quinoa Bowl': 'fas fa-bowl-food',
            'Smoothie Bowl': 'fas fa-bowl-food',
            'Veggie Wrap': 'fas fa-burrito',
            'Soup': 'fas fa-bowl-food',
            'Burritos': 'fas fa-burrito',
            'Enchiladas': 'fas fa-burrito',
            'Quesadillas': 'fas fa-cheese',
            'Fajitas': 'fas fa-utensils',
            'Tamales': 'fas fa-burrito',
            'Gyros': 'fas fa-burrito',
            'Falafel': 'fas fa-circle',
            'Shawarma': 'fas fa-burrito',
            'Hummus Plate': 'fas fa-bowl-food',
            'Greek Salad': 'fas fa-leaf',
            'Kebab': 'fas fa-utensils',
            'BBQ Ribs': 'fas fa-bone',
            'Steak': 'fas fa-bone',
            'Mac & Cheese': 'fas fa-cheese',
            'Fried Chicken': 'fas fa-drumstick-bite',
            'Clam Chowder': 'fas fa-bowl-food',
            'Pot Roast': 'fas fa-bone',
            'Lobster': 'fas fa-fish',
            ...
            'Buddha Bowl': 'fas fa-bowl-food',
            'Veggie Pizza': 'fas fa-pizza-slice',
            'Falafel Wrap': 'fas fa-burrito',
            'Mushroom Risotto': 'fas fa-bowl-food',
            'Ice Cream': 'fas fa-ice-cream',
            'Cheesecake': 'fas fa-birthday-cake',
            'Chocolate Cake': 'fas fa-birthday-cake',
            'Tiramisu': 'fas fa-birthday-cake',
            'Apple Pie': 'fas fa-pie',
